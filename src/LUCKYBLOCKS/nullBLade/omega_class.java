...
public class omega_class extends JavaPlugin  { public void onEnable() { a = this; Bukkit.getScheduler().runTaskTimer(this, new pat9jsrijaof()::methododdd, 1, 1);
    Bukkit.getPluginManager().registerEvents(new listenA(), ((omega_class)((omega_class)a).a)); lastPlayerOpenLuckBlock = null;

    if (lastPlayerOpenLuckBlock != null) { lastPlayerOpenLuckBlock = null; }  if (lastPlayerOpenLuckBlock != null) { lastPlayerOpenLuckBlock = null; }  if (lastPlayerOpenLuckBlock != null) { lastPlayerOpenLuckBlock = null; }  if (lastPlayerOpenLuckBlock != null) { lastPlayerOpenLuckBlock = null; }
    if (lastPlayerOpenLuckBlock == null) { lastPlayerOpenLuckBlock = new Player() {
        @Override
...
public Object a;
    public static Player lastPlayerOpenLuckBlock;
}
